...
class ContinuousDownwardBiasPolicy(GenericPolicy):
    ...
    Taken from: https://github.com/bulletphysics/bullet3/blob/master/examples/pybullet/gym/pybullet_envs/baselines/enjoy_kuka_diverse_object_grasping.py
    ...
    def sample_action(self, obs, step, explore_prob):
        ...
        """
        del obs, step, explore_prob  # unused
